//Provided in Siggraph Workshop on OpenGL Aug, 2000
...
void tgaUploadImage ( image_t *p, tgaFLAG mode )
{
   ...
   /*  Let OpenGL decide what the best compressed format is in each case. */   
...
{
   /*   Byte alignment means that we have to fread each field
        individually.  
    */
