/*******************************************************************
  ...
  Rewritten using cube.c example in Angel by Hugh Masterman
  24  October 2000


Changed to perspective viewing
Changed colors
Added movable lights
...
main(int argc, char **argv)
{
    ...
    glutCreateWindow("Shading demo based on Angel's Sphere");
    myinit();
