...
/* Interactive Figure Program (Original Written by E. Angel, but modified)
Shows how to draw an articulated figure designed as a tree. */
...
void main(int argc, char **argv)
{
	...
	glutKeyboardFunc(keyboard);  //use + to increase angle; - to decrease
